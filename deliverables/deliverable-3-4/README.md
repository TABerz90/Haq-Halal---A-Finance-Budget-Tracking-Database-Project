...
|--------|-----------------|
| Talha Ahmad | Backend auth, schema BCNF audit, route architecture |
| Muhammad Ibrahim | Dashboard analytics, views integration, frontend state management |
| Muhammad Aariz | React pages, UI design system, form validation |
